...
Public Class college_reports
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LCC_SAMS_Project.college_reports.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_date_start() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedcollege_reports
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As college_reports = New college_reports()
        rpt.Site = Me.Site
        Return rpt
    End Function
